...
<ul>
   ...
   <li class='active'><a href='./it.php'><span>IT VERIFICATION</span></a></li>
...
try {
    ...
    $sql = "SELECT t.* FROM SAE.CurrentSAE t join sae.v_current_sae_status v on t.recordid = v.recordid and v.STATUS = 3";
      $i = 0;
        ...
        //Table heading
        echo"<thead>";
        echo '<tr class="header" style="background-color: #ffbf00;">';
       ...
       // print $row['Unit'] .' - '. $row['SubUnit'] . '<br />';
        ...
        echo ' <td nowrap><a href="./case_view.php?action=open&tab=it&recordkey='.urlencode($row['recordid']).'"class="button">OPEN</a></td>';
        echo" </tr> ";
        }
